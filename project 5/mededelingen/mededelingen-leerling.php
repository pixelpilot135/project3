...
$mededelingen = $mededeling->getMededelingenByRole('leerling');
?>
...
<head>
    ...
    <title>Mededelingen van Leerlingen</title>
...
<div class="container mt-5">
    <h1 class="mb-4">Mededelingen van Leerlingen</h1>

    <?php if (empty($mededelingen)): ?>
        <div class="alert alert-warning">
            Er zijn momenteel geen mededelingen van leerlingen beschikbaar.
        </div>
    <?php else: ?>
