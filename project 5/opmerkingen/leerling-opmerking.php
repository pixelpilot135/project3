...
// Haal de lessen op voor de leerling
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $gebruiker_id = $_POST['gebruiker_id']; // Het ID van de leerling (in dit geval hardcoded, dit moet dynamisch worden op basis van de ingelogde gebruiker)
...
<head>
    ...
    <title>Opmerking Toevoegen (Leerling)</title>
</head>
<body>
    ...
    <form method="POST">
        ...
        <label for="gebruiker_id">Je ID (leerling):</label>
